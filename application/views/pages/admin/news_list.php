					...
					<form method="post" enctype="multipart/form-data">
						<?php
							$fields = [
								...
								['name' => 'ka_description', 'value' => set_value('ka_description')],
								['name' => 'en_description', 'value' => set_value('en_description')],
								['name' => 'ru_description', 'value' => set_value('ru_description')],
